...
var _SwedishLayout = require('./layouts/SwedishLayout');

var _SwedishLayout2 = _interopRequireDefault(_SwedishLayout);
...
var _HideKeyboardIcon = require('./icons/HideKeyboardIcon');

var _HideKeyboardIcon2 = _interopRequireDefault(_HideKeyboardIcon);

var _ClearFieldIcon = require('./icons/ClearFieldIcon');

var _ClearFieldIcon2 = _interopRequireDefault(_ClearFieldIcon);
	...
	_createClass(Keyboard, [{
		...
		value: function getKeys() {
			...
			if (this.state.showSymbols) {
				...
				keysSet = _SwedishLayout2.default;
			} else {
				keysSet = _LatinLayout2.default;
			}
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					{ className: 'keyboard-row' },
					_react2.default.createElement(_KeyboardButton2.default, {
						value: _react2.default.createElement(_ClearFieldIcon2.default, null),
					...
					_react2.default.createElement(_KeyboardButton2.default, {
						value: _react2.default.createElement(_HideKeyboardIcon2.default, null),
